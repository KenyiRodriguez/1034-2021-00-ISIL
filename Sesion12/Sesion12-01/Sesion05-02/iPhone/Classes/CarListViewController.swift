...
class CarListViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //ESTA DATA LA DEBERÍAS SACAR DEL FIREBASE
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        }else if let controller = segue.destination as? AddCarViewController {
...
extension CarListViewController: AddCarViewControllerDelegate {
    
    func addCarViewController(_ controller: AddCarViewController, saveCar objCar: Car) {
        
        self.arrayCars.append(objCar)
        self.tlbCars.reloadData()
    }
}
